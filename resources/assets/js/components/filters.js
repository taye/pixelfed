...
export const filterEffects = [
    {
      name: '1984',
      ops: [
        { type: EffectOpType.SEPIA, intensity: [0, 0.5] },
    ...
    },
    {
      name: 'Azen',
      ops: [
        { type: EffectOpType.SEPIA, intensity: [0, 0.2] },
    ...
    },
    {
      name: 'Astairo',
      ops: [
        { type: EffectOpType.SEPIA, intensity: [0, 0.35] },
    ...
    },
    {
      name: 'Bookrun',
      ops: [
        { type: EffectOpType.SEPIA, intensity: [0, 0.4] },
    ...
    },
    {
      name: 'Borough',
      ops: [
        { type: EffectOpType.SEPIA, intensity: [0, 0.25] },
    ...
    },
    {
      name: 'Hairsadone',
      ops: [
        { type: EffectOpType.SEPIA, intensity: [0, 0.15] },
        { type: EffectOpType.ADJUST_COLOR, args: [0.25, 0.25, 0] },
        { type: EffectOpType.HUE_ROTATE, args: [5] },
      ],
    },
    ...
    },
    {
      name: 'Daisy',
      ops: [
        { type: EffectOpType.SEPIA, intensity: [0, 0.75] },
    ...
    },
    {
      name: 'Xenon',
      ops: [
        { type: EffectOpType.SEPIA, intensity: [0, 0.45] },
